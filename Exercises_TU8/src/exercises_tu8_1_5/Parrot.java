...
public class Parrot {
	...
	private static int numberOfParrots;
	...
	public static void setNumberOfParrots(int numberOfParrots) {
		Parrot.numberOfParrots = numberOfParrots;
	}
